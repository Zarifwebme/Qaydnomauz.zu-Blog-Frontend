...
export function setNavAuthState() {
  ...
  const loggedInHtml = `
    <div class="d-flex align-items-center gap-2 flex-wrap nav-auth-wrap">
      <a class="btn btn-light border rounded-3 px-3 nav-auth-btn" href="/profile/">
  ...
  const guestHtml = `
    <div class="d-flex align-items-center gap-2 flex-wrap nav-auth-wrap">
      <a class="btn btn-outline-primary rounded-3 px-3 nav-auth-btn" href="/login/">
        <i class="bi bi-box-arrow-in-right me-1"></i> Kirish
      </a>
      <a class="btn btn-primary rounded-3 px-3 nav-auth-btn" href="/register/">
