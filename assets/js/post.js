...
function safeSetImg(sel, src, alt) {
  const el = qs(sel);
  if (el) {
    el.onerror = function () { this.onerror = null; this.src = "assets/images/404img.jpg"; };
    el.src = src || "assets/images/404img.jpg";
    el.alt = alt || "";
  }
}
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-3 overflow-hidden">
      ${
        post.image_url
          ? `
          <a href="${href}">
            <img src="${post.image_url}" alt="${escapeHtml(post.title || "")}" class="w-100" style="height:160px; object-fit:cover;" onerror="this.onerror=null;this.src='assets/images/404img.jpg';">
          </a>
          `
          : ""
      }
